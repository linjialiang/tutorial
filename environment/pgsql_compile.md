...
wget https://ftp.postgresql.org/pub/source/v16.1/postgresql-16.2.tar.bz2
tar -xjf postgresql-16.2.tar.bz2 -C ~/
chown postgres:postgres -R ~/postgresql-16.2
mkdir ~/postgresql-16.2/build_postgres
```
...
su - postgres -s /bin/zsh
cd ~/postgresql-16.2/build_postgres
...
make install
# 编译安装完后记得移除源码包，节省空间
rm -rf ~/postgresql-16.2 ~/postgresql-16.2.tar.bz2
```
