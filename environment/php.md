...
```bash [83]
mkdir /home/php-fpm/php-8.3.14/build_php
cd /home/php-fpm/php-8.3.14/build_php/
```
...
# php8.3
cp /home/php-fpm/php-8.3.14/php.ini-development /server/php/83/lib/php.ini
```
...
# php8.3
cp /home/php-fpm/php-8.3.14/php.ini-production /server/php/83/lib/php.ini
```
