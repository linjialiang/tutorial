...
```bash [拷贝到8.3]
cp -p -r apcu-5.1.23 /home/php-fpm/php-8.3.9/ext/apcu
cp -p -r redis-6.0.2 /home/php-fpm/php-8.3.9/ext/redis
cp -p -r yaml-2.2.3 /home/php-fpm/php-8.3.9/ext/yaml
```
...
mkdir /home/php-fpm/php-8.3.9/build_php
```
...
# php8.3 构建目录
cd /home/php-fpm/php-8.3.9/build_php/
```
...
# php8.3
cp /home/php-fpm/php-8.3.9/php.ini-production /server/php/83/lib/php.ini
```
...
# php8.3
cp /home/php-fpm/php-8.3.9/php.ini-development /server/php/83/lib/php.ini
```
